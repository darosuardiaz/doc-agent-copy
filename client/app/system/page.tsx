  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-800">Monitor system health and performance metrics</p>
      </div>
          ...
          {health?.services && Object.entries(health.services).map(([service, status]) => (
            <div key={service} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-3">
                {service === 'database' && <Database className="h-5 w-5 text-gray-800" />}
                {service === 'openai' && <Brain className="h-5 w-5 text-gray-800" />}
                {service === 'pinecone' && <HardDrive className="h-5 w-5 text-gray-800" />}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-800">Chat Sessions</span>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-800">Research Tasks</span>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-800">Vector Store</span>
      ...
      {stats?.vector_store && (
        <div className="bg-white rounded-lg shadow-sm border p-6 mt-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              <span className="text-gray-800 text-sm">Total Vectors</span>
              <p className="font-medium text-gray-900">{stats.vector_store.total_vectors.toLocaleString()}</p>
            </div>
            <div>
              <span className="text-gray-800 text-sm">Dimension</span>
              <p className="font-medium text-gray-900">{stats.vector_store.dimension}</p>
            </div>
            <div>
              <span className="text-gray-800 text-sm">Index Fullness</span>
              <p className="font-medium text-gray-900">{(stats.vector_store.index_fullness * 100).toFixed(2)}%</p>
            </div>
            <div>
              <span className="text-gray-800 text-sm">Avg per Document</span>
